 ...
 * [isSupported], so [app.frad.chat.wideradius.WideRangeChatController]
 * degrades the same way [app.frad.chat.ble.BleChatController] already
 * does when [app.frad.chat.wifidirect.WifiDirectTransferManager] is
 ...
 *  type must exist so [app.frad.chat.wideradius.WideRangeChatController]
