 ...
 * [isSupported], so [me.woelki.frad.wideradius.WideRangeChatController]
 * degrades the same way [me.woelki.frad.ble.BleChatController] already
 * does when [me.woelki.frad.wifidirect.WifiDirectTransferManager] is
 ...
 *  type must exist so [me.woelki.frad.wideradius.WideRangeChatController]
