...
sealed interface ChatUiState {
    ...
    data class Browsing(val nearbyPeers: List<me.woelki.frad.pairing.NearbyPeer>) : ChatUiState

    data class Connecting(val target: me.woelki.frad.pairing.NearbyPeer) : ChatUiState
