 ...
 * their bytes are read back and handed to [me.woelki.frad.chat.ChatController.sendFile] (which
 * copies them into [me.woelki.frad.data.MediaFileStore] for the message they become) - see
