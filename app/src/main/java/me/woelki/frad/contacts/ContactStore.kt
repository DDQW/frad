package me.woelki.frad.contacts

import android.content.Context

/** A peer saved on-device, keyed by their long-term peer id (see [me.woelki.frad.crypto.Identity.peerId]). */
 ...
 * Purely local — like [me.woelki.frad.safety.BlockList], there is no server to
