package me.woelki.frad.profile
 ...
 * [me.woelki.frad.crypto.Identity.peerId], a pseudonym is *not* required to be
...
class Profile(context: Context) {
    ...
    /** Set only via [me.woelki.frad.wideradius.Geohash.encode] truncated to
     *  [me.woelki.frad.wideradius.Geohash.MAX_PRECISION] or coarser (or typed in
     ...
     *  DHT rendezvous topic — see [me.woelki.frad.wideradius.Geohash.precisionForRadiusKm]. */
     ...
     *  multiaddr, e.g. from a [p2p-go/cmd/bootstrap][me.woelki.frad.wideradius] operator) —
