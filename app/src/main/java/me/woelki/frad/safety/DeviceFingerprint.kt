...
/**
 * Best-effort per-device id, independent of [me.woelki.frad.crypto.Identity]'s keypair,
 ...
 * function. Exchanged with a peer the same way [me.woelki.frad.crypto.Identity.peerId] is
