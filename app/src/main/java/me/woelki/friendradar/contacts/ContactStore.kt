...
/** A peer saved on-device, keyed by their long-term peer id (see [me.woelki.friendradar.crypto.Identity.peerId]). */
 ...
 * Purely local — like [me.woelki.friendradar.safety.BlockList], there is no server to
...
class ContactStore(context: Context) {
    ...
    private companion object {
        const val PREFS_FILE = "friendradar_contacts"
