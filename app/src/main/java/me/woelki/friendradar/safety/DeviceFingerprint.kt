...
/**
 * Best-effort per-device id, independent of [me.woelki.friendradar.crypto.Identity]'s keypair,
 ...
 * function. Exchanged with a peer the same way [me.woelki.friendradar.crypto.Identity.peerId] is
