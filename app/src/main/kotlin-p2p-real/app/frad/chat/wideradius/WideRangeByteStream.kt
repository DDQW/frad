...
import app.frad.chat.p2pgo.node.Stream as GoStream

/**
 * A single libp2p stream (chat or file-transfer protocol — see
 * [app.frad.chat.wideradius.WideRangeChatController]), wrapping the
 * gomobile-generated [GoStream]. Plain byte in/out, same as
 * [app.frad.chat.ble.Framing] expects — gomobile can't bind
...
class WideRangeByteStream internal constructor(private val goStream: GoStream) {
     ...
     *  other end of this stream — distinct from [app.frad.chat.crypto.ChatSession.remotePeerId],
