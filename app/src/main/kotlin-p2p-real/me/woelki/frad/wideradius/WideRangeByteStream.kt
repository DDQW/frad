...
import me.woelki.frad.p2pgo.node.Stream as GoStream

/**
 * A single libp2p stream (chat or file-transfer protocol — see
 * [me.woelki.frad.wideradius.WideRangeChatController]), wrapping the
 * gomobile-generated [GoStream]. Plain byte in/out, same as
 * [me.woelki.frad.ble.Framing] expects — gomobile can't bind
...
class WideRangeByteStream internal constructor(private val goStream: GoStream) {
     ...
     *  other end of this stream — distinct from [me.woelki.frad.crypto.ChatSession.remotePeerId],
